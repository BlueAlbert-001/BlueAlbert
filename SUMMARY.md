...
* [主模块1：卖量助手](selling/README.md)
  ...
  * [技术接入指南](selling/dev-guide/README.md)
    ...
    * [【通用】登录/用户信息](selling/dev-guide/login/README.md)
      ...
      * [.updateUserInfo(注意更新)](selling/dev-guide/login/update-userinfo.md)
      * [.updateUserProfile](selling/dev-guide/login/updateuserprofile.md)
...
* [主模块2：买量助手](channel/README.md)
  * [主要功能及操作说明](channel/main-features/README.md)
    ...
    * [微信广告投放说明](channel/main-features/wechat-ad.md)
    * [自动计算成本](channel/main-features/cost-calculations.md)
  * [渠道类型说明](channel/channe\_type.md)
  * [数据指标说明](channel/data-indicator.md)
  * [技术接入指南](channel/dev-guide/README.md)
    * [接入前必读](channel/dev-guide/must-read.md)
...
* [主模块3：游戏数据](game-data/README.md)
  ...
  * [技术接入指南](game-data/dev-guide/README.md)
    * [接入前必读](game-data/dev-guide/must-read.md)
    ...
    * [内购分析](game-data/dev-guide/pay.md)
...
* [主模块4：游戏配置](game-set/README.md)
  * [主要功能及操作说明](game-set/main-features/README.md)
    ...
    * [用户日志（暂未开放）](game-set/main-features/userlog.md)
...
* [通用功能说明](general-function/README.md)
  ...
  * [获取accessToken](general-function/accesstoken.md)
* [技术接入指南](dev/README.md)
  * [必须或基础功能](dev/basic/README.md)
    ...
    * [同步玩家游戏信息](dev/basic/sync\_player\_info.md)
  * [卖量助手类功能](dev/selling/README.md)
    * [准备工作（必读）](dev/start.md)
    * [组件化方式接入广告位](dev/selling/componentization/README.md)
      * [.createflow](dev/selling/componentization/createflow/README.md)
        * [渲染多Icon广告位](dev/selling/componentization/createflow/more-icon.md)
        * [渲染浮动窗广告位](dev/selling/componentization/createflow/icon.md)
        * [渲染插屏广告位](dev/selling/componentization/createflow/screen-ad.md)
        * [渲染伪视频广告位](dev/selling/componentization/createflow/like-video.md)
    * [API方式接入广告位](dev/selling/api/README.md)
  ...
  * [游戏数据类功能](dev/data/README.md)
    * [内购分析](dev/data/purchase.md)
    * [微信视频分析（.createRewardedVideoAd）](dev/data/createRewardedVideoAd.md)
    * [微信banner分析（.createBannerAd）](dev/data/createBannerAd.md)
    * [性能分析 （.sendLoadingLog）](dev/data/sendLoadingLog.md)
  * [游戏配置类功能](dev/config/README.md)
    * [版本控制 （.getJudgeConfig）](dev/config/getJudgeConfig.md)
    ...
    * [悬浮窗](dev/config/floatingcustomer.md)
